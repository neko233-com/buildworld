...
export default function CreateProject() {
  ...
  useEffect(() => {
    ...
    setFormat(config.trim().startsWith('{') ? 'json' : 'yaml')
  ...
  const switchFormat = (nextFormat: 'json' | 'yaml') => { setFormat(nextFormat); setForm(previous => ({ ...previous, config: nextFormat === 'json' ? SAMPLE_JSON : SAMPLE_YAML, template_id: '' })) }
